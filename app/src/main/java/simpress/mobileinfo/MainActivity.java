...
*/
    ...
    private void hiddenApp(){
        ...
        ComponentName componentName = new ComponentName(this, simpress.mobileinfo.MainActivity.class); // activity which is first time open in manifiest file which is declare as <category android:name="android.intent.category.LAUNCHER" />
        ...
        Toast.makeText(this, "APP oculto iniciado.", Toast.LENGTH_SHORT).show();
    }
    ...
    private class Listener implements LocationListener {
        ...
        public void onLocationChanged(Location location){
            ...
            if (a.hour >= 7 && a.hour <= 18 && a.weekDay > 1 && a.weekDay < 7){// && (a.minute == 0 || a.minute == 30)) { //rodará apenas no horário comercial
                try {
                    if(hasLocation) {
                        if (checkPermission("android.permission.READ_PHONE_STATE")) {
                            getIMEI();
